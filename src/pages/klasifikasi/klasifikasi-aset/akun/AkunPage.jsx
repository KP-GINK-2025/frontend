...
const AkunPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setAkunData([
        // Contoh data jika perlu
        // { id: 1, kodeAset: "AK001", namaAset: "Aset Tanah", kode: "TNH" },
        // { id: 2, kodeAset: "AK002", namaAset: "Aset Bangunan", kode: "BGN" },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      setAkunData([
        // Bisa isi ulang data dari sumber asli di sini
      ]);
      setLoading(false);
    }, 1000);
  };
  ...
  const handleAddAkun = () => {
    console.log("Menambahkan Akun...");
  };

  const handleExport = () => {
    console.log("Exporting akun data...");
  };
