...
import { useSubSubRincianPageLogic } from "./useSubSubRincianPageLogic";

const SubSubRincianPage = () => {
  const { state, handler } = useSubSubRincianPageLogic();
  ...
  const columns = useMemo(
    () => [
        ...
        renderCell: (params) => {
          ...
          return (
            <div className="flex gap-2 items-center h-full">
              ...
              <button
                onClick={() => handler.handleDeleteSubSubRincian(params.row.id)}
      ...
      },
      {
        ...
        renderCell: (params) => {
          if (!params.row) return null;
          return (
            state.subSubRincianData.findIndex(
      ...
      },
      {
        ...
        renderCell: (params) => {
          const akun =
            params.row.sub_rincian_aset.rincian_objek_aset.objek_aset.jenis_aset
      ...
      },
      {
        ...
        renderCell: (params) => {
          const jenis =
            params.row.sub_rincian_aset.rincian_objek_aset.objek_aset
              .jenis_aset;
          return jenis
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const rincian = params.row.sub_rincian_aset.rincian_objek_aset;
          return rincian
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const sub = params.row.sub_rincian_aset;
          return sub
            ? `${sub.kode_sub_rincian_aset} - ${sub.nama_sub_rincian_aset}`
            : "N/A";
        },
      },
    ...
    [state.subSubRincianData, state.paginationModel, handler]
  );
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-y-4 mb-4">
            ...
            <div className="flex w-full sm:w-auto md:justify-end gap-2">
              ...
              >
                <Plus size={16} /> Tambah Sub Sub Rincian
              </Buttons>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-4">
            ...
            />
            <FilterDropdown
              value={state.selectedSubRincian}
              onChange={(e) => {
                handler.setSelectedSubRincian(e.target.value);
              }}
              options={state.subRincianList}
              placeholder={
                state.selectedRincianObjek
                  ? "-- Semua Sub Rincian --"
                  : "Pilih rincian objek dahulu"
              }
              loading={state.loadingSubRincian}
              disabled={!state.selectedRincianObjek}
            />
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            ...
            <div className="w-full md:w-auto">
              <SearchInput
                placeholder="Cari sub sub rincian..."
      ...
      <AddSubSubRincianModal
        ...
        onSave={handler.handleSaveSubSubRincian}
        initialData={state.editingSubSubRincian}
      />
    </div>
  );
};
