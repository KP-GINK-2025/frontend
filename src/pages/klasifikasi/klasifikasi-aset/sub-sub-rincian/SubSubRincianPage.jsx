...
const SubSubRincianPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setSubSubRincianData([
        // Contoh data dummy
        // { id: 1, aset1: "Akun 1", aset2: "Kelompok Bangunan", aset3: "Jenis Bangunan Kantor", aset4: "Objek Gedung Perkantoran", aset5: "Rincian Gedung Kantor Utama", aset6: "Sub Rincian Lantai 1", kodeAset7: "SSR001", namaAset7: "Sub Sub Rincian Ruang A", kode: "SSRA1" },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  const handleAddSubSubRincian = () => {
    console.log("Menambahkan Sub Sub Rincian...");
  };
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleAddSubSubRincian}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Aset 6</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Kode Aset 7</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Nama Aset 7</th>
                ...
                {loading ? (
                  ...
                  currentData.map((item, index) => (
                    <tr key={item.id || index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-700">{item.aset6}</td>
                      <td className="py-3 px-4 text-gray-700">{item.kodeAset7}</td>
                      <td className="py-3 px-4 text-gray-700">{item.namaAset7}</td>
