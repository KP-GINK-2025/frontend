...
import { useRincianObjekPageLogic } from "./useRincianObjekPageLogic";

const RincianObjekPage = () => {
  const { state, handler } = useRincianObjekPageLogic();
  ...
  const columns = useMemo(
    () => [
        ...
        renderCell: (params) => {
          ...
          return (
            <div className="flex gap-2 items-center h-full">
              ...
              <button
                onClick={() => handler.handleDeleteRincianObjek(params.row.id)}
      ...
      },
      {
        ...
        renderCell: (params) => {
          if (!params.row) return null;
          return (
            state.rincianObjekData.findIndex(
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const akun = params.row.objek_aset.jenis_aset.kelompok_aset.akun_aset;
          return akun
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const kelompok = params.row.objek_aset.jenis_aset.kelompok_aset;
          return kelompok
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const jenis = params.row.objek_aset.jenis_aset;
          return jenis
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const objek = params.row.objek_aset;
          return objek
      ...
      {
        field: "kode_rincian_objek_aset",
        headerName: "Kode Rincian Objek",
        width: 120,
      },
      {
        field: "nama_rincian_objek_aset",
        headerName: "Nama Rincian Objek",
        flex: 1,
        minWidth: 250,
      },
      {
    ...
    [state.rincianObjekData, state.paginationModel, handler]
  );
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-y-4 mb-4">
            ...
            <div className="flex w-full sm:w-auto md:justify-end gap-2">
              ...
              >
                <Plus size={16} /> Tambah Rincian Objek
              </Buttons>
            </div>
          </div>
      ...
      <AddRincianObjekModal
        ...
        onSave={handler.handleSaveRincianObjek}
        initialData={state.editingRincianObjek}
      />
    </div>
  );
};
