...
import { useRincianObjekForm } from "./useRincianObjekForm";
...
const AddRincianObjekModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const {
    ...
    isFormValid,
    dataToSave,
  } = useRincianObjekForm(initialData, isOpen);
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-800">
                {initialData ? "EDIT RINCIAN OBJEK" : "TAMBAH RINCIAN OBJEK"}
              </h2>
              <button
                onClick={onClose}
                disabled={isSaving}
            ...
            >
              ...
              <InputForm
                formTitle="Kode Rincian Objek"
                id="kodeRincianObjek"
                type="text"
                value={formState.kodeRincianObjek}
              ...
              <InputForm
                formTitle="Nama Rincian Objek"
                id="namaRincianObjek"
                type="text"
                value={formState.namaRincianObjek}
                onChange={handleInputChange}
                disabled={isSaving}
              />
