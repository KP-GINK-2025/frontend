...
import { useKelompokPageLogic } from "./useKelompokPageLogic";

const KelompokPage = () => {
  const { state, handler } = useKelompokPageLogic();
  ...
  const columns = useMemo(
    () => [
        ...
        renderCell: (params) => {
          ...
          return (
            <div className="flex gap-2 items-center h-full">
              ...
              <button
                onClick={() => handler.handleDeleteKelompok(params.row.id)}
      ...
      },
      {
        ...
        renderCell: (params) => {
          if (!params.row) return null;
          return (
            state.kelompokData.findIndex((row) => row.id === params.row.id) +
            1 +
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const akun = params.row.akun_aset;
          return akun
      ...
      {
        field: "kode_kelompok_aset",
        headerName: "Kode Kelompok",
        width: 120,
      },
      {
        field: "nama_kelompok_aset",
    ...
    [state.kelompokData, state.paginationModel, handler]
  );
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
      ...
      <AddKelompokModal
        ...
        onSave={handler.handleSaveKelompok}
        initialData={state.editingKelompok}
      />
    </div>
  );
};
