...
const KelompokPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setKelompokData([
        // Contoh data dummy
        // { id: 1, aset1: "Akun 1", kodeAset2: "KLP001", namaAset2: "Kelompok Bangunan", kode: "KBG" },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
  ...
  const handleAddKelompok = () => {
    console.log("Menambahkan Kelompok...");
  };
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Kode Aset 2</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Nama Aset 2</th>
                ...
                {loading ? (
                  ...
                  currentData.map((item, index) => (
                    <tr key={item.id || index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-700">{item.kodeAset2}</td>
                      <td className="py-3 px-4 text-gray-700">{item.namaAset2}</td>
