...
import { useKelompokForm } from "./useKelompokForm";
...
const AddKelompokModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const {
    ...
    isFormValid,
    dataToSave,
  } = useKelompokForm(initialData, isOpen);
        ...
        >
          ...
          >
            ...
            >
              ...
              <InputForm
                formTitle="Kode Kelompok"
                id="kodeKelompok"
                type="text"
                value={formState.kodeKelompok}
              ...
              <InputForm
                formTitle="Nama Kelompok"
                id="namaKelompok"
                type="text"
                value={formState.namaKelompok}
                onChange={handleInputChange}
                disabled={isSaving}
              />
