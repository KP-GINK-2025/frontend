...
const JenisPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setJenisData([
        // Contoh data dummy
        // { id: 1, aset1: "Akun 1", aset2: "Kelompok Bangunan", kodeAset3: "JNS001", namaAset3: "Jenis Bangunan Kantor", kode: "JBK" },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Kode Aset 3</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Nama Aset 3</th>
                ...
                {loading ? (
                  ...
                  currentData.map((item, index) => (
                    <tr key={item.id || index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-700">{item.kodeAset3}</td>
                      <td className="py-3 px-4 text-gray-700">{item.namaAset3}</td>
