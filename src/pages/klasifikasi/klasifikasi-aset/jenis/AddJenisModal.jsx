...
import { useJenisForm } from "./useJenisForm";
...
const AddJenisModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const {
    ...
    isFormValid,
    dataToSave,
  } = useJenisForm(initialData, isOpen);
          ...
          >
            ...
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-800">
                {initialData ? "EDIT JENIS" : "TAMBAH JENIS"}
              </h2>
              <button
                onClick={onClose}
                disabled={isSaving}
            ...
            >
              ...
              <InputForm
                formTitle="Kode Jenis"
                id="kodeJenis"
                type="text"
                value={formState.kodeJenis}
              ...
              <InputForm
                formTitle="Nama Jenis"
                id="namaJenis"
                type="text"
                value={formState.namaJenis}
                onChange={handleInputChange}
                disabled={isSaving}
              />
