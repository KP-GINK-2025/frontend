...
const ObjekPage = () => {
  ...
  useEffect(() => {
    setTimeout(() => {
      setObjekData([
        // Contoh data dummy
        // { id: 1, aset1: "Akun 1", aset2: "Kelompok Bangunan", aset3: "Jenis Bangunan Kantor", kodeAset4: "OBJ001", namaAset4: "Objek Gedung Perkantoran", kode: "OGP" },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Kode Aset 4</th>
                  <th className="text-left py-3 px-4 font-semibold text-gray-700">Nama Aset 4</th>
                ...
                {loading ? (
                  ...
                  currentData.map((item, index) => (
                    <tr key={item.id || index} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-700">{item.kodeAset4}</td>
                      <td className="py-3 px-4 text-gray-700">{item.namaAset4}</td>
