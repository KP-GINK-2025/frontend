...
import { useObjekPageLogic } from "./useObjekPageLogic";

const ObjekPage = () => {
  const { state, handler } = useObjekPageLogic();
  ...
  const columns = useMemo(
    () => [
        ...
        renderCell: (params) => {
          ...
          return (
            <div className="flex gap-2 items-center h-full">
              ...
              <button
                onClick={() => handler.handleDeleteObjek(params.row.id)}
      ...
      },
      {
        ...
        renderCell: (params) => {
          if (!params.row) return null;
          return (
            state.objekData.findIndex((row) => row.id === params.row.id) +
            1 +
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const akun = params.row.jenis_aset.kelompok_aset.akun_aset;
          return akun
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const kelompok = params.row.jenis_aset.kelompok_aset;
          return kelompok
      ...
      },
      {
        ...
        minWidth: 250,
        renderCell: (params) => {
          const jenis = params.row.jenis_aset;
          return jenis
      ...
      {
        field: "kode_objek_aset",
        headerName: "Kode Objek",
        width: 120,
      },
      {
        field: "nama_objek_aset",
        headerName: "Nama Objek",
        flex: 1,
        minWidth: 250,
      },
      {
    ...
    [state.objekData, state.paginationModel, handler]
  );
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
      ...
      <AddObjekModal
        ...
        onSave={handler.handleSaveObjek}
        initialData={state.editingObjek}
      />
    </div>
  );
};
