...
import { useBidangForm } from "./useBidangForm";
...
const AddBidangModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  const {
    ...
    isFormValid,
    dataToSave,
  } = useBidangForm(initialData, isOpen);
        ...
        >
          ...
          >
            ...
            >
              ...
              <InputForm
                formTitle="Kode Bidang"
                id="kodeBidang"
                type="text"
                value={formState.kodeBidang}
              ...
              <InputForm
                formTitle="Nama Bidang"
                id="namaBidang"
                type="text"
                value={formState.namaBidang}
                onChange={handleInputChange}
                disabled={isSaving}
              />
