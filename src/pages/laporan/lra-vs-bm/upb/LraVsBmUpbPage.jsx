  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
      ...
      <div className="px-8 py-8">
        <Breadcrumbs />
        <h1 className="text-2xl font-bold mb-4 mt-4">LRA VS BM UPB</h1>
        ...
        <div className="flex justify-center mt-8">
          <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-3xl">
            <h2 className="text-center font-bold text-lg mb-2 uppercase">
              LAPORAN REALISASI ANGGARAN VS BELANJA MODAL (UPB)
            </h2>
